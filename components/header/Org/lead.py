...
class Lead:
    ...
    def __init__(self, parent):
        ...
        def fetch_lead_data():
            ...
            cursor.execute("SELECT id, date, name, contactperson FROM leadlist")
            ...
            for leadrow in lead_data:
                (lead_no, date, name, contact_person) = leadrow
                self.tree.insert(
                    "", "end", values=(lead_no, date, name, contact_person)
                )
        ...
        self.date_filder_icon = Image.open("asset/Lead_icon/calendar.png")
